...
const InicioAnimado = ({ setCurrentPage }) => {
  return (
    <div className="relative min-h-screen bg-green-500 flex flex-col items-center justify-center overflow-hidden">
      {/* Símbolo de reciclaje animado flotante y giratorio */}
      ...
      <div className="relative z-10 text-center">
        ...
        <button
          ...
          className="bg-white text-green-600 px-10 py-4 rounded-full text-xl font-bold shadow-lg transition transform duration-300 hover:scale-110 hover:bg-green-100 hover:text-green-800 animate-bounce-in"
        >
          ¡Empieza a Reciclar!
        </button>
      </div>
